...
const ExpandMenu = (props) => {
  const [opts]=useState([{name:'WORK',link:'/portfolio', key:'work'},{name:'ABOUT', link:'/about',key:'about'},{name:'GALLERY',link:'/gallery',key:'gallery'},{name:'CONTACT', link:'/contact', key:'contact'},]);
