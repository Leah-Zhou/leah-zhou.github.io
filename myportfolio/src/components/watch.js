  ...
  return (
    <div className="project-container">
      <section className="project-title">
        ...
        <h2 style={{fontSize:"21px", fontWeight:'400'}}>Pocket Watch</h2>
        </div>
      ...
      <section>
        ...
        {watchThumbnails.map(each=>(
                <div className="icon-imgs">
                   <li key={each.keyOne} ><img src={each.imgOne} alt={each.altOne} style={heroImg} /></li>
      ...
      <section>
        <h3>Product Advertisement Video</h3>
